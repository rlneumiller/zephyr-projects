...
> For common CH340G implementations (16-pin chip), **TX** and **RX** are typically **pins 2 and 3**. Connect these to their counterparts on your esp32c3 (I disabled SPI2 and assigned pins 4 and 5 to uart0).
